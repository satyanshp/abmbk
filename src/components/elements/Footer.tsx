  ...
  return (
    <Box id='footer'>
        ...
        <Box display='flex' flexDirection={{md:'column',xs:'column-reverse'}}>
            <Box fontFamily= "'Open Sans', sans-serif" color='rgba(187, 187, 187, 1)' fontSize='0.85rem' textAlign={{md:'left',xs:'center'}} width={{md:'90%',xs:'100%'}} margin={{md:'auto',xs:'0px 0px 20px 0px'}}>© Law chambers of Akanksha Choudhary</Box>
