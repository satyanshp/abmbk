			...
			>
				...
				>
					<Box>
						<Box
							...
							height={{ md: '12vh', xs: 'fit-content' }}
							alignItems='center'
							padding={{ md: '0px 25px', xs: '0px' }}
						>
							{/* <Box width='100%' display={{ md: 'none', xs: 'flex' }} flexDirection='column'>
								<Box
									onClick={() => blogOnClickMenu()}
									margin='auto'
									display={{ md: 'none', xs: 'flex' }}
									alignItems='center'
									width='90%'
									justifyContent='space-between'
									sx={{ '@media (max-width:900px)': { height: '6vh' } }}
								>
									<Box>All Posts</Box>
								...
								<Box
									position='relative'
									className={blogMenuOpen ? 'app__blog__res__menu active' : 'app__blog__res__menu'}
									sx={{
										background: '#FFFFFF',
										'>div': {
											height: '6vh',
											paddingLeft: '5vw',
											display: blogMenuOpen ? 'flex' : 'none',
											alignItems: 'center',
										},
									}}
								>
									<Box
										className={
											blogMenuOpen
												? 'app__blog__res__menu__links active'
												: 'app__blog__res__menu__links'
										}
										borderBottom='1px solid rgb(221, 221, 221)'
										borderTop='1px solid rgb(221, 221, 221)'
										onClick={() => onClickBlogNavLinks()}
									>
										Arbitration
									</Box>
									<Box
							...
							<Box
								...
								sx={{
									'>div': {
										cursor: 'pointer',
										'&:hover': { color: '#377DBD', '>div': { color: '#000000' } },
									},
								}}
							>
								...
								>
									...
									<Box
										...
										top='100%'
										width='200px'
										boxShadow='0px 10px 11px 0 rgb(0 0 0 / 5%)'
									>
										<Box
											display='flex'
											flexDirection='column'
										...
										>
											{searchOpen && (
												<Box borderBottom='1px solid rgb(221, 221, 221)'>Property Law</Box>
											)}
											<Box
												borderBottom='1px solid rgb(221, 221, 221)'
												onClick={() => onClickBlogNavLinks()}
							...
							<Box
								...
								alignItems='center'
								justifyContent={'space-between'}
								sx={{ '@media (max-width:900px)': { background: '#377DBD', height: '6vh' } }}
								width={{ xs: '100%', md: 'fit-content' }}
							>
								{!searchOpen && (
									<Box display={{ xs: 'flex', md: 'none' }} marginLeft='5vw' color='#FFFFFF'>
										{' '}
										BLOG
									</Box>
								)}
								<Box display='flex' alignItems='center' gap={{ md: 5, xs: 2 }}>
									<Box display='flex' alignItems='center'>
										{!searchOpen && (
											<SearchIcon
												sx={{ cursor: 'pointer', '@media (max-width:900px)': { color: '#FFFFFF' } }}
												onClick={() => onClickSearch()}
											/>
										)}
										{searchOpen && (
											<Box
												className='app__blog__search'
												display='flex'
												minWidth='150px'
												padding='0 5px'
												height='30px'
												...
												sx={{ background: '#FFFFFF' }}
											>
												<Box display='flex' marginRight='3px'>
													<SearchIcon sx={{ color: 'black', width: '19px' }} />
												</Box>
												<Box display='flex'>
													<input className='app__blog__input' type='text' placeholder='Search' />
												</Box>
												<Box display='flex'>
													<CloseIcon
														onClick={() => onClickClose()}
														sx={{ cursor: 'pointer', color: 'black', width: '17px' }}
													/>
												</Box>
											</Box>
										)}
									...
									<Box padding='24px 36px' flexGrow='1'>
										<Box display='flex' justifyContent='space-between' sx={{ cursor: 'pointer' }}>
											<Box display='flex' gap={1}>
												<Avatar
													sx={{ bgcolor: 'red', width: '32px', height: '32px', fontSize: '1.1rem' }}
												>
													A
												</Avatar>
												...
												<Box position='relative'>
													...
													{verMenu && (
														<Box
															...
															right='18px'
															width='200px'
															boxShadow='0px 3px 8px 0 rgb(0 0 0 / 20%)'
														>
															<Box
																display='flex'
																flexDirection='column'
															...
															>
																<Box display='flex' gap='8px' fontSize='14px'>
																	<ReplyOutlinedIcon
																		sx={{ transform: 'scaleX(-1)', width: '21px' }}
																	/>
																	Share Post
																</Box>
															</Box>
										...
										<Box>
											<Box
												...
												className='app__blog__des__title'
												fontSize='1.8rem'
											>
												{blogData.title}
											</Box>
										...
										<Box display='flex' alignItems='center' justifyContent='space-between'>
											...
											<Box
												fontSize='0.85rem'
												sx={{ cursor: 'pointer', '&:hover': { color: '#377DBD' } }}
											>
												arbitation
											</Box>
										</Box>
				...
				>
					...
					<Box marginBottom={5} display='flex' justifyContent='center' gap={1}>
						<Box display='flex' width='23px' height='23px'>
							<img
								style={{ width: '100%', objectFit: 'contain' }}
